...
(function (global) {
  ...
  var CONFIG = {
    ...
    stones: {
       ...
       * 라운드든 오벌이든 같은 크기면 같은 값입니다. */
      natural: {
        label: '천연석',
        note: '일주에 맞춘 원석. 각을 내지 않고 둥글게 갈아낸 캐보션이며, ' +
          '테두리로 감싸 물립니다. 라운드와 오벌은 값이 같습니다. 공임은 값에 포함돼 있습니다.',
        cut: '캐보션',
        shapes: { round: '라운드 (동그란)', oval: '오벌 (길쭉한)' },
        sizes: [
          { mm: 1.5, label: '1.5mm', price: 20000, hint: '작게 포인트로' },
          { mm: 3.0, label: '3.0mm', price: 25000, hint: '은은한 한 알' },
          { mm: 4.0, label: '4.0mm', price: 30000, hint: '또렷한 한 알' },
          { mm: 5.0, label: '5.0mm 이상', price: 40000, hint: '가운데 주인공' }
        ],
        mm: 5.0,
