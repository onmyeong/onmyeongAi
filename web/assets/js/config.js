...
(function (global) {
  ...
  var CONFIG = {
    ...
    studio: {
      ...
      address: '',                 // 예: 서울특별시 ○○구 ○○로 00, 3층
      addressNote: '방문은 예약제로 운영합니다. 주문 상담에서 시간을 잡아 주세요.',
      hours: '',                   // 예: 화~토 13:00 ~ 19:00 (일·월 휴무)
      mapUrl: '',                  // 예: 네이버 지도 링크
      story: [
    ...
    care: {
      ...
      items: [
        ...
        ['집에서 닦는 법',
          ...
          '홈이 깊은 디자인은 부드러운 칫솔에 주방세제를 약간 묻혀 헹군 뒤 물기를 완전히 닦아 주세요.'],
        ['이건 피해 주세요',
    ...
    as: {
      ...
      contact: '네이버 톡톡으로 문의해 주시면 가장 빠릅니다.',
